...
var nd3d = (function(){
	...
	nd3dcss3js.Dom3DCore = (function(){
		...
		Dom3DCore.prototype =
		{
			...
			_matrix	:	function()
			{
				...
				$(this.view).css( nd3dcss3js.browserString + 'transform', 'translate3d('+this.translate.toString()+') matrix3d(' + this.matrix3d.toString() + ') scale3d(' + this.scale3d.toString() + ')' );
			},
			lookAt	:	function( _obj )
			{
				var _dx = this.position.x = _obj.x;
				var _dy = this.position.y = _obj.y;
				var _dz = this.position.z = _obj.z;
	...
	nd3dcss3js.world = (function(){
		...
		world.prototype._matrix = function( e )
		{
			...
			$(this.view).css( nd3dcss3js.browserString + 'transform', 'translate3d('+this.translate.toString()+') matrix3d(' + this.matrix3d.toString() + ') scale3d(' + _scale.toString() + ')' );
		}
